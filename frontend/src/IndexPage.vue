...
// จากตัวอย่างก่อน
const gitSteps = [
  { title: 'Git Branching', detail: 'แยกสายการทำงานอย่างชัดเจน' },
  { title: 'Git Push', detail: 'ส่งโค้ดขึ้น GitHub' }
];
const dockerItems = [
  { title: 'Containerization', detail: 'รันแอปในสภาพแวดล้อมที่คงที่' },
  { title: 'Orchestration', detail: 'จัดการกลุ่ม container ด้วย compose' }
];
